...
const Shuffle = ({ user }) => {
  ...
  const [gameState, setGame] = useState("paused");
  ...
  const playerImages = [
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/2b/2b9aed1575082b421a43908a5af1fe25f2325188_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/5a/5a12f0b1fbebc63fc44f73e1f8fb091b120f4a23_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/7b/7b8512b9d40a7fb8e2420cf0a0b11227822670de_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/71/715c744b6c17570f84fd2031816ed0869e9d3b65_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/5a/5a22cccc638bf670081aefed5d8d4a0688bc74e3_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/48/486cc7363316983d0b28b906430a8b38b6110187_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/c0/c0ea4e7de108c1ec22920a070e3d743fe78615f9_full.jpg",
  ];

  const playerImagesNew = [
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/2b/2b9aed1575082b421a43908a5af1fe25f2325188_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/71/715c744b6c17570f84fd2031816ed0869e9d3b65_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/48/486cc7363316983d0b28b906430a8b38b6110187_full.jpg",
    "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/5a/5a12f0b1fbebc63fc44f73e1f8fb091b120f4a23_full.jpg",
  ...
  const playerPicked = (randomModule, winningTicket, winner, currentCup) => {
    // show animation idk...
    setAnimation("none");
    setTransform("translateX(0px)");

    // FIXME: Replace with actual winner animation
    setTimeout(() => {
      setTransform("translateX(-340.5rem)");
  ...
  const tick = () => {
    ...
    if (time === 0) {
      ...
      setTimeout(() => setTransform("translateX(-340.5rem)"), 1000);
      setTimeout(() => setAnimation("3s ease"), 1000);
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                setTimeout(() => setWinner(winnerBall[random]), 1000);
                setTimeout(() => setAnimation("3s ease"), 1000);
                setTimeout(() => setTransform("translateX(-340.5rem)"), 1000);
              }, 5000);
            }, 5000);
